        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand nav-link" href="{{ url('/parkir') }}">
                        <p class="logo"><span>TumPark</span>Our</p>
                    </a>
                </div>
            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a href="{{ url('parkir') }}" class="waves-effect waves-dark"  aria-expanded="false">
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('fasilitas/hariini') }}">Semua Data Parkir</a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('parkir/input') }}">Input Parkir</a></li>
                                <li><a href="{{ url('parkir/data') }}">Data Parkir</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
