			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-body">
						...
						<hr>
						<form action="{{ url('parkir/update/'.$data->id)}}" method="post">
							@csrf @method('patch')
							<div class="form-group">
								<label for="">Plat Nomor</label>
								<input type="text" maxlength="8" name="plat_nomor" class="form-control" value="{{$data->plat_nomor}}">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" maxlength="10" name="nama_kendaraan" class="form-control" value="{{$data->nama_kendaraan}}">
							</div>
